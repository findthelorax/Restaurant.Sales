...
export function TeamMemberSelect({ team, value = '', onChange }) {
	const { setSelectedTeamMember } = useContext(TeamMembersContext);
...
export function DailyTotalsFormRender({ dailyTotals, handleDailyTotalsChange, handleSubmit, selectedTeamMember }) {
